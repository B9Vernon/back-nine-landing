...
export function generatePersonalEmail(company: CompanyForOutreach): GeneratedEmail {
  ...
  const body = [
    ...
    "",
    `Back Nine is a premium 24/7 indoor golf facility with private simulator bays, Full Swing technology, public tee times, and corporate membership options. For your ${teamLabel}, it can be an easy staff perk, a polished place to host people, or a private team experience that works year-round.`,
    "",
    "A few simple ways this could work:",
    "",
    bullets,
    "",
    "The idea is to keep it flexible and useful for your team, rather than turn it into a complicated program. The current hiring activity seemed like a natural reason to introduce the option now.",
    "",
